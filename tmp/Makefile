...
TESTS = dispatch_apply$(EXEEXT) dispatch_api$(EXEEXT) \
	dispatch_c99$(EXEEXT) dispatch_deadname$(EXEEXT) \
	dispatch_debug$(EXEEXT) dispatch_queue_finalizer$(EXEEXT) \
	dispatch_group$(EXEEXT) dispatch_overcommit$(EXEEXT) \
	dispatch_pingpong$(EXEEXT) dispatch_plusplus$(EXEEXT) \
	dispatch_priority$(EXEEXT) dispatch_priority2$(EXEEXT) \
	dispatch_concur$(EXEEXT) dispatch_context_for_key$(EXEEXT) \
	dispatch_proc$(EXEEXT) dispatch_read$(EXEEXT) \
	dispatch_read2$(EXEEXT) dispatch_after$(EXEEXT) \
	dispatch_timer$(EXEEXT) dispatch_timer_short$(EXEEXT) \
	dispatch_timer_timeout$(EXEEXT) dispatch_sema$(EXEEXT) \
	dispatch_suspend_timer$(EXEEXT) dispatch_timer_bit31$(EXEEXT) \
	dispatch_timer_bit63$(EXEEXT) dispatch_timer_set_time$(EXEEXT) \
	dispatch_starfish$(EXEEXT) dispatch_cascade$(EXEEXT) \
	dispatch_drift$(EXEEXT) dispatch_readsync$(EXEEXT) \
	dispatch_data$(EXEEXT) dispatch_io$(EXEEXT) \
	dispatch_io_net$(EXEEXT) dispatch_vm$(EXEEXT) \
	dispatch_vnode$(EXEEXT) dispatch_select$(EXEEXT) \
...
libbsdtests_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	...
	$@
am__EXEEXT_1 = dispatch_cf_main$(EXEEXT) \
	dispatch_transform$(EXEEXT) \
	dispatch_sync_on_main$(EXEEXT) \
	cffd$(EXEEXT)
am__EXEEXT_2 = dispatch_sync_gc$(EXEEXT) \
...
dispatch_deadname_SOURCES = dispatch_deadname.c
dispatch_deadname_OBJECTS = dispatch_deadname.$(OBJEXT)
dispatch_deadname_LDADD = $(LDADD)
dispatch_deadname_DEPENDENCIES = libbsdtests.la ../src/libdispatch.la
...
SOURCES = $(libbsdtests_la_SOURCES) $(bench_SOURCES) bsdtestharness.c \
	...
	dispatch_context_for_key.c dispatch_data.c dispatch_deadname.c \
	dispatch_debug.c dispatch_drift.c dispatch_group.c \
	dispatch_io.c dispatch_io_net.c dispatch_overcommit.c \
	dispatch_pingpong.c $(dispatch_plusplus_SOURCES) \
	dispatch_priority.c $(dispatch_priority2_SOURCES) \
	dispatch_proc.c dispatch_queue_finalizer.c dispatch_read.c \
	dispatch_read2.c dispatch_readsync.c dispatch_select.c \
	dispatch_sema.c dispatch_starfish.c dispatch_suspend_timer.c \
...
ACLOCAL = ${SHELL} /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch/config/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch/config/missing autoconf
AUTOHEADER = ${SHELL} /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch/config/missing autoheader
AUTOMAKE = ${SHELL} /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch/config/missing automake-1.15
AWK = awk
BSD_OVERLAY_CFLAGS = 
BSD_OVERLAY_LIBS = 
...
CPPFLAGS =  -isystem ../libpthread-137.1.1 -isystem ../libclosure-65 -idirafter ../xnu-3247.1.106/libkern -isystem ../xnu-3247.1.106/bsd -isystem ../xnu-3247.1.106/libsyscall -isystem ../xnu-3247.1.106/libsyscall/wrappers/libproc  -isystem ../libauto-186 -DPRIVATE=1
...
CXXFLAGS = -arch x86_64 -arch i386 -g -Os
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DLLTOOL = false
DSYMUTIL = dsymutil
...
INSTALL = /opt/gnu/coreutils/bin/install -c
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch/config/missing makeinfo
MANIFEST_TOOL = :
MARCH_FLAGS = 
MIG = /usr/bin/mig
MKDIR_P = /opt/gnu/coreutils/bin/mkdir -p
NM = /usr/bin/nm
NMEDIT = nmedit
OBJC = clang
OBJCFLAGS = -arch x86_64 -arch i386 -g -Os
OBJCPP = clang -E
OBJCXX = clang++
OBJCXXFLAGS = -g -O2
OBJDUMP = false
...
OTOOL64 = :
PACKAGE = libdispatch
PACKAGE_BUGREPORT = libdispatch@macosforge.org
PACKAGE_NAME = libdispatch
PACKAGE_STRING = libdispatch 1.3
PACKAGE_TARNAME = libdispatch
PACKAGE_URL = http://libdispatch.macosforge.org
PACKAGE_VERSION = 1.3
PATH_SEPARATOR = :
...
abs_builddir = /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch/tests
abs_srcdir = /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch/tests
abs_top_builddir = /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch
abs_top_srcdir = /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch
ac_ct_AR = ar
ac_ct_CC = 
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/zchee/src/github.com/apple/swift-corelibs-libdispatch/config/install-sh
...
dispatch_deadname$(EXEEXT): $(dispatch_deadname_OBJECTS) $(dispatch_deadname_DEPENDENCIES) $(EXTRA_dispatch_deadname_DEPENDENCIES) 
	@rm -f dispatch_deadname$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(dispatch_deadname_OBJECTS) $(dispatch_deadname_LDADD) $(LIBS)
...
dispatch_proc$(EXEEXT): $(dispatch_proc_OBJECTS) $(dispatch_proc_DEPENDENCIES) $(EXTRA_dispatch_proc_DEPENDENCIES) 
	@rm -f dispatch_proc$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(dispatch_proc_OBJECTS) $(dispatch_proc_LDADD) $(LIBS)
...
dispatch_vm$(EXEEXT): $(dispatch_vm_OBJECTS) $(dispatch_vm_DEPENDENCIES) $(EXTRA_dispatch_vm_DEPENDENCIES) 
	@rm -f dispatch_vm$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(dispatch_vm_OBJECTS) $(dispatch_vm_LDADD) $(LIBS)

dispatch_vnode$(EXEEXT): $(dispatch_vnode_OBJECTS) $(dispatch_vnode_DEPENDENCIES) $(EXTRA_dispatch_vnode_DEPENDENCIES) 
	@rm -f dispatch_vnode$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(dispatch_vnode_OBJECTS) $(dispatch_vnode_LDADD) $(LIBS)
